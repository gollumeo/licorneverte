<div>
    <footer class="w-full border-t border-t-gray-700 md:min-h-12 bg-blue-200 dark:bg-gray-700 dark:border-b-gray-300 flex text-sm flex-col content-center h-fit">

        <div class="flex md:flex-row w-full md:items-center md:content-center m-auto flex-col ">
