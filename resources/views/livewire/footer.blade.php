<div>
    <footer class="w-full border-t border-t-gray-700 md:min-h-12 bg-blue-200 dark:bg-gray-700 dark:border-t-gray-300 flex text-sm flex-col content-center h-fit">

        <div class="flex md:flex-row w-full md:items-center md:content-center m-auto flex-col border-gray-700 dark:border-gray-300 ">
            <img src="{{asset('assets/luxe.png')}}" class="md:w-2/12 w-1/3 self-center place-self-center" />
            ...
            <img src="{{asset('assets/epv_full.png')}}" class="md:w-2/12 w-1/3 self-center place-self-center" />
        </div>
