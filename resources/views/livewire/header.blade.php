<div class="w-full border-b border-b-gray-700 md:h-28 sticky bg-blue-200 dark:bg-gray-700 dark:border-b-gray-300 flex">
    <nav class="w-full m-auto flex flex-row items-center md:justify-between justify-end">
        ...
        <label for="theme" class="flex flex-row items-center hover:cursor-pointer p-4">
            ...
            <button id="theme" name="theme" x-on:click="darkMode = !darkMode; localStorage.setItem('darkMode', darkMode.toString());" x-bind:class="darkMode ? 'after:translate-x-5' : 'after:translate-x-0'" class="dark:bg-gray-300 md:w-12 md:h-7 w-10 h-5 rounded-full flex flex-shrink-0 items-center dark:after:bg-slate-900 bg-gray-700 after:bg-blue-100 md:after:w-5 after:w-3 md:after:h-5 after:h-3 after:rounded-full p-1 ease-in-out duration-500 after:ease-in-out after:duration-500 ml-4 mr-4">
            </button>
            <svg class="w-6 md:w-8 dark:fill-gray-300 fill-slate-700" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 30.457 30.457">
